...
while True:
    ...
    found_key == False
    if found_key == False and value == 'K':  # if found Key => update game state
        found_key = True 
        os.system('cls')
        print_map(map, ROWS, COLS)
    elif found_key == False and value == 'D':  # if found Door => update map, check winning then end the game
        print('YOU LOSE.')
    ...
    print_map(map, ROWS, COLS)
    if found_key and value == 'D':  # if Key has been found => user win
        print('YOU WON!!!')
        break  # end the game
